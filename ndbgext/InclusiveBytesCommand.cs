...
public sealed class InclusiveBytesCommand : DbgEngCommand
{
    public InclusiveBytesCommand(nint pUnknown, bool redirectConsoleOutput = true)
    ...
    {
        int topN = ParseTopN(args, defaultValue: 20);
